...
<div class="sidebar-master">
    ...
    <a href="listar_motos.php" class="sidebar-item <?= ($pagina_actual == 'listar_motos.php') ? 'active' : '' ?>">
   ...
   <a href="listar_repuestos.php" class="sidebar-item <?= ($pagina_actual == 'listar_repuestos.php') ? 'active' : '' ?>">
    ...
    <a href="buscador_ajax.php" class="sidebar-item <?= ($pagina_actual == 'buscador_ajax.php') ? 'active' : '' ?>">
        <i class='bx bx-search-alt'></i> <span>Buscador</span>
    </a>
